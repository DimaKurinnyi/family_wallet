...
export const About: React.FC<Props> = ({ className }) => {
  return (
    <div id="about" className={cn('pb-15', className)}>
      <Title text="About Expense Tracker" size="lg" className="text-white font-bold text-center mb-8 sm:mb-15" />

      <div className="flex flex-col lg:flex-row items-center lg:justify-around gap-8">
        <Image src="/assets/About.webp" alt="about" width={500} height={500} className="border rounded-2xl w-full max-w-[500px] h-auto" />
        <p className="text-gray-300 lg:mx-20 text-base sm:text-lg max-w-[65ch]">
